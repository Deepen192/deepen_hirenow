...
class ViewContractDetails extends StatelessWidget {
  final String userId;
  const ViewContractDetails({Key? key, required this.userId});
        ...
        child: SizedBox(
          ...
          child: Card(
            ...
            shape: RoundedRectangleBorder(
                ...
                side: BorderSide(
                    width: 2, color: Colors.grey.shade700 //(0xFFFF00FF),
                    )),
            child: SizedBox(
               width: 10.0,
              height: 10.0,
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow(
                      'Contract Duration:', '2080-03-01 to 2080-09-30'),
                  ...
                  _buildDetailRow(
                      'Non-Competition:', '6 months post-employment'),
                  _buildDetailRow('Benefits:',
                      'Basic injury and health treatment available'),
